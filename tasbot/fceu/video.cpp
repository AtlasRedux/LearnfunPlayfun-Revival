...
int FCEU_InitVirtualVideo(void)
{
	if(!XBuf)		/* Some driver code may allocate XBuf externally. */
		...
		*/
		...
		/* Align XBuf to a 16-byte boundary so that uint32* casts
		   in the PPU code and any SSE/AVX auto-vectorisation are safe.
		   The original code only aligned on 32-bit builds; this version
