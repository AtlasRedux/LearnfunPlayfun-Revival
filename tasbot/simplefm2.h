...
struct SimpleFM2 {
  ...
  // dense vector (one entry per input frame). Frames without an explicit
  // subtitle inherit the previous one; frames before any subtitle get "".
  ...
  // into a sparse representation. Handles repeated subtitles.
